...
start
:explore the data to obtain important features
 and descriptive statistics about the dataset.;
:properly split the data into testing and training subsets;
:determine a suitable performance metric for this problem.;
:analyze performance graphs for a learning algorithm
 with varying parameters and training set sizes.;
:pick the optimal model that best generalizes for unseen data;
:test this optimal model on a new sample;
:compare the predicted selling price to your statistics;
end
```
